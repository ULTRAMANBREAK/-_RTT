<template>
  <view class="page">
    ...
    <view class="card">
      ...
      <text class="hint">竞赛演示版 · 任意账号密码均可登录</text>
    </view>
...
.page {
  min-height: 100vh;
  background: linear-gradient(160deg, #FF6B35 0%, #FF8C42 40%, #FFB347 100%);
  display: flex;
...
.btn-active  { background: linear-gradient(135deg, #FF6B35, #FF8C42); box-shadow: 0 8rpx 32rpx rgba(255,107,53,0.4); }
...
/* 提示 */
.hint { display: block; text-align: center; font-size: 22rpx; color: #ccc; }
</style>
